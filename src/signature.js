                                        ...
                                        {this.state.url}
                                            <div className="clipBoard">
                                                ...
                                                <Clipboard  onSuccess={(e)=>{
                                                    ...
                                                    setTimeout(()=>{ 
                                                        e.trigger.classList.remove('success')}, 1500);
                                                    }}
...
export const SignatureCreate = props => (
                    ...
                    <FormDataConsumer>
                        {({ formData, ...rest }) => {
                            if (formData) {
                                return (
                                    <>
                                        <img alt='assinatura' src={`${API_URL}/preview/${formData.type}/${window.btoa(JSON.stringify(formData))}`}></img>
                                    </>
                                )
                            }
                        }
